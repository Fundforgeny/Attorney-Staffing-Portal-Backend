class PaymentMethod < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    ["card_brand", "cardholder_name", "created_at", "exp_month", "exp_year", "id", "id_value", "is_default", "last4", "provider", "stripe_payment_method_id", "updated_at", "user_id", "vault_token"]
  end
